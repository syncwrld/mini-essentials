package me.syncwrld.interview.miniessentials.util.config;
...
public class YAML extends YamlConfiguration {
	...
	public YAML(String name, Plugin plugin) {
		...
		try {
			...
			throw new RuntimeException("Couldn't create file '" + name + "' for plugin '" + plugin.getDescription().getName() + "':", e);
		}
	}
